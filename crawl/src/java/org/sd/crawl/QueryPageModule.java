...
/**
 * A site info module that keeps track of queries.
 * <p>
 * @author Spence Koehler
 */
public class QueryPageModule extends BaseSuccessfulSiteInfoModule {
  
  public QueryPageModule() {
    super();
  }
  ...
  protected final void doAdd(CrawledPage crawledPage, int crawlDepth, DetailedUrl dUrl) {
    ...
    if (query != null && !"".equals(query)) {
      hstring = dUrl.getNonQueryNormalizedUrl();
    }

    super.addString(hstring, url);
  }
}
