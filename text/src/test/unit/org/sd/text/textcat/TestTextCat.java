...
public class TestTextCat extends TestCase {
  ...
  public void testTexts() throws IOException {
    ...
    doTestTexts(textCat, FileUtil.getFile(this.getClass(), LANGUAGE_TEST_FILE_DIR1), false, true);
    doTestTexts(textCat, FileUtil.getFile(this.getClass(), LANGUAGE_TEST_FILE_DIR2), false, true);
  }

  public void testConstrainedTexts() throws IOException {
    final TextCat textCat = new TextCat(new String[]{"dutch", "english", "german"});
    doTestTexts(textCat, FileUtil.getFile(this.getClass(), LANGUAGE_TEST_FILE_DIR1), true, false);
    doTestTexts(textCat, FileUtil.getFile(this.getClass(), LANGUAGE_TEST_FILE_DIR2), true, false);
  }
