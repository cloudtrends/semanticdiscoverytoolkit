 ...
 */
public class CollectSensesOperator implements WordSenseOperator {
  
  private List<WordSenseWrapper> senses;

  public CollectSensesOperator() {
    this.senses = new ArrayList<WordSenseWrapper>();
  }

  public List<WordSenseWrapper> getSenses() {
    return senses;
  }
