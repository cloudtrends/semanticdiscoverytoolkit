...
/**
 * A message to get a new local id for a job from a node.
 * <p>
 * @author Spence Koehler
 */
public class AcquireJobIdMessage extends DirectResponseMessage {
  
  public AcquireJobIdMessage() {
  }
  ...
  public Message getResponse(Context context) {
    ...
    return new IntegerResponse(context, clusterContext.getJobManager().getNextLocalJobId());
  }
}
