 ...
 */
public class PublishableResponse extends SignedResponse {

  private Publishable publishable;

  public PublishableResponse() {
    super();
    this.publishable = null;
  }

  public PublishableResponse(Context context, Publishable publishable) {
    super(context);
    this.publishable = publishable;
  }

  public Publishable getValue() {
    return publishable;
  }
  ...
  public void read(DataInput dataInput) throws IOException {
    ...
    this.publishable = MessageHelper.readPublishable(dataInput);
  }

  public String toString() {
    return getSignature() + ": " + publishable;
  }
}
