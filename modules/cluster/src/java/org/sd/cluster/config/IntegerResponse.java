 ...
 */
public class IntegerResponse extends SignedResponse {
  ...
  public IntegerResponse(Context context, Integer integer) {
    super(context);
  ...
  public void read(DataInput dataInput) throws IOException {
    ...
    final boolean hasValue = dataInput.readBoolean();
    if (hasValue) {
