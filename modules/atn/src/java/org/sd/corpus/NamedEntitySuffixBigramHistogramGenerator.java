...
/**
 * Histogram generator for tokens immediately following a named entity.
 * <p>
 * @author Abe Sanderson
 */
public class NamedEntitySuffixBigramHistogramGenerator 
  extends CorpusHistogramGenerator 
{
  ...
  public NamedEntitySuffixBigramHistogramGenerator(DataProperties topOptions, 
  ...
  protected String[] generateHistogramStrings(Token token) {
    ...
    {
      String[] splits = token.getText().split(" ");
      String lastEntityWord = splits[splits.length - 1];
      String suffixWord = next.getText();
      
      StringBuilder builder = new StringBuilder();
      builder.append(lastEntityWord);
      builder.append(" END_ENTITY ");
      builder.append(suffixWord);
  ...
  public static void main(String[] args) throws IOException {
    final NamedEntitySuffixBigramHistogramGenerator generator =
      (NamedEntitySuffixBigramHistogramGenerator)doMain(args, new InstanceBuilder() {
          public CorpusHistogramGenerator buildInstance(DataProperties options, String[] args, File histogramGeneratorConfig) throws IOException {
            return new NamedEntitySuffixBigramHistogramGenerator(options, histogramGeneratorConfig);
          }
        });
  }
}
