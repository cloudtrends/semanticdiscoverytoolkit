 ...
 */
public class NamedEntitySuffixHistogramGenerator 
  extends CorpusHistogramGenerator 
{
  ...
  public NamedEntitySuffixHistogramGenerator(DataProperties topOptions, 
  ...
  protected String[] generateHistogramStrings(Token token) {
    ...
    if(isEntity(token) && next != null && !isEntity(next))
      result = new String[]{next.getText()};
    return result;
  }

  public static void main(String[] args) throws IOException {
    final NamedEntitySuffixHistogramGenerator generator =
      (NamedEntitySuffixHistogramGenerator)doMain(args, new InstanceBuilder() {
          public CorpusHistogramGenerator buildInstance(DataProperties options, String[] args, File histogramGeneratorConfig) throws IOException {
            return new NamedEntitySuffixHistogramGenerator(options, histogramGeneratorConfig);
          }
        });
  }
}
