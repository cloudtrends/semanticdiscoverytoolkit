...
/**
 * A site info module that keeps track of missing titles.
 * <p>
 * @author Spence Koehler
 */
public class MissingTitleModule extends BaseSuccessfulSiteInfoModule {
  
  public MissingTitleModule() {
    super();
  }
  ...
  protected final void doAdd(CrawledPage crawledPage, int crawlDepth, DetailedUrl dUrl) {
    ...
    if (title == null || "".equals(title)) {
      super.addString("", url);  // keep track of urls for pages w/out a title
    }
  }
}
