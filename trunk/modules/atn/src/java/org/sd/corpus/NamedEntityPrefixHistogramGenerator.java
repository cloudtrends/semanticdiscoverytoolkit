 ...
 */
public class NamedEntityPrefixHistogramGenerator 
  extends CorpusHistogramGenerator 
{
  ...
  public NamedEntityPrefixHistogramGenerator(DataProperties topOptions, 
  ...
  public static void main(String[] args) throws IOException {
    final NamedEntityPrefixHistogramGenerator generator =
      (NamedEntityPrefixHistogramGenerator)doMain(args, new InstanceBuilder() {
          public CorpusHistogramGenerator buildInstance(DataProperties options, String[] args, File histogramGeneratorConfig) throws IOException {
            return new NamedEntityPrefixHistogramGenerator(options, histogramGeneratorConfig);
          }
        });
  }
}
