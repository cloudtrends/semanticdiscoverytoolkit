 ...
 */
public class TimeOrderIterator extends BaseDbIterator<StringKeyValuePair> {
  ...
  public TimeOrderIterator(DbInfo dbInfo, boolean forward, String dbMarkerId) {
  ...
  protected final StringKeyValuePair doInitFirst(DbInfo dbInfo, boolean forward) throws DatabaseException {
    ...
    return getNextStringPair(dbInfo, pKey, value, opStatus);
  }
  ...
  protected final StringKeyValuePair doGetNext(DbInfo dbInfo, boolean forward) throws DatabaseException {
    ...
    if (this.cursor != null) {
      ...
      if (opStatus == OperationStatus.SUCCESS) {
        result = getNextStringPair(dbInfo, pKey, value, opStatus);
      }
    }
