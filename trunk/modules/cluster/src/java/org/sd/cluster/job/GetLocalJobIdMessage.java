...
/**
 * A message to get the local jobID for a job.
 * <p>
 * @author Spence Koehler
 */
public class GetLocalJobIdMessage extends DirectResponseMessage {

  private String description;

  public GetLocalJobIdMessage() {
  }

  public GetLocalJobIdMessage(Job job) {
    this.description = job.getDescription();
  }

  public GetLocalJobIdMessage(String description) {
  ...
  public void write(DataOutput dataOutput) throws IOException {
    ...
    MessageHelper.writeString(dataOutput, description);
  }
  ...
  public Message getResponse(Context context, ConnectionContext connectionContext) {
    ...
    Integer localId = clusterContext.getJobManager().getLocalId(description);
    if (localId == null) {
      localId = -1;  // signify error.
    }
    return new PublishableResponse(context, new LocalJobId(myNodeName, localId));
  }
}
